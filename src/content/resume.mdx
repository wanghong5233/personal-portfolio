...
- **工程交付**：Python、asyncio、FastAPI、PostgreSQL、Redis、Docker、WebSocket / SSE
- **Agent 系统**：LangGraph、Multi-Agent、ReAct、Tool Calling、MCP、Prompt Engineering、Agent Runtime
- **RAG / 检索**：RAG、Hybrid Search、Embedding、Rerank、pgvector
...
- 结果：完整演示路径覆盖确定性选码、评论证据与回流校准；Shopify App Store Listing 审核中。
- 详情：[/projects/corvia-fit](/projects/corvia-fit)
