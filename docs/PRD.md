...
| 与 Pulse / ScholarMind / Resona 关系 | 展示 Demo、视频、截图、源码、架构文档与复盘文章；不嵌入其业务代码 |
...
| 技术面试官 | 已知候选人有项目，想快速判断技术深度 | 能看到架构、职责、代码、Demo、复盘和设计取舍 | `/projects` → `/projects/<slug>` → GitHub / Demo |
...
| 项目阶段完成 | 每个里程碑后 | 截图、Demo、架构图、职责、复盘、设计取舍 |
...
- Pulse / ScholarMind / Resona 等项目的演示视频、截图、架构图、源码链接与复盘接入本站。
